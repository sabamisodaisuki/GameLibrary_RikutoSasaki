...
void lnitScore(void)
{
	...
	g_posScore = D3DXVECTOR3(620.0f,10.0f,0.0f);//位置を初期化する
	g_nScore = 0; //値を初期化する
	//ブロックの情報の初期化
...
void SetScore(int nScore , D3DXVECTOR3 pos, float fWidth, float fHeight)
{
	...
	aPosTexU[0] = g_nScore % 100000  / 10000;
	aPosTexU[1] = g_nScore % 10000 / 1000;
	aPosTexU[2] = g_nScore % 1000 / 100;
	aPosTexU[3] = g_nScore % 100 / 10;
	aPosTexU[4] = g_nScore % 10 / 1;
