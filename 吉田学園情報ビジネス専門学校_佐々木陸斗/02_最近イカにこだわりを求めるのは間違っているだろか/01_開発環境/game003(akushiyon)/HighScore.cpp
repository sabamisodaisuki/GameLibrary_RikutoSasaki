...
void lnitHigeScore(void)
{
	...
	g_posHigeScore = D3DXVECTOR3(620.0f, 50.0f, 0.0f);//位置を初期化する
	...
	SetHigeScore(g_nHigeScore, D3DXVECTOR3(610.0f, 50.0f, 0.0f), (20.0f), (10.0f));
}
...
void SetHigeScore(int nScore, D3DXVECTOR3 pos, float fWidth, float fHeight)
{
	...
	aPosTexU[0] = g_nHigeScore % 100000 / 10000;
	aPosTexU[1] = g_nHigeScore % 10000 / 1000;
	aPosTexU[2] = g_nHigeScore % 1000 / 100;
	aPosTexU[3] = g_nHigeScore % 100 / 10;
	aPosTexU[4] = g_nHigeScore % 10 / 1;
