...
void lnitTime(void)
{
	...
	g_posTime = D3DXVECTOR3(510.0f, 5.0f, 0.0f);//位置を初期化する
	g_nTime = 0;								//値を初期化する
	g_nTimetime = 0;
	...
	for (nCntTime = 0; nCntTime < MAX_TIME; nCntTime++)
	{
		...
		pVtx[0].pos = D3DXVECTOR3(g_posTime.x + 50.0f*nCntTime, g_posTime.y - 0.0f, 0.0f);
		pVtx[1].pos = D3DXVECTOR3(g_posTime.x + 50.0f + 50.0f*nCntTime, g_posTime.y - 0.0f, 0.0f);
		pVtx[2].pos = D3DXVECTOR3(g_posTime.x + 50.0f*nCntTime, g_posTime.y + 50.0f, 0.0f);
		pVtx[3].pos = D3DXVECTOR3(g_posTime.x + 50.0f + 50.0f*nCntTime, g_posTime.y + 50.0f, 0.0f);
