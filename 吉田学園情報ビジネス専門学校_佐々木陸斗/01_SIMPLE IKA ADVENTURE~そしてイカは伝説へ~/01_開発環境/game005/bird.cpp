...
#define MAX_BIRD	(1235)				//モデルの最大数
#define NUM_BIRD	(2)				//モデル数
#define Bird_G		(0.25f)
//============================================================
//グローバル変数
//============================================================
...
void UpdateBird(void)
{
	...
	if (g_nBirdCounter % 340 == 0)
	{
		SetBird(D3DXVECTOR3(3320.0f,1500.0f, -590.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXVECTOR3(-9.0f, 0.0f, 0.0f), 1); //車1
		SetBird(D3DXVECTOR3(1850.0f,1500.0f, -590.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXVECTOR3(-9.0f, 0.0f, 0.0f), 1); //車1
		SetBird(D3DXVECTOR3(3600.0f,1500.0f, -590.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXVECTOR3(-9.0f, 0.0f, 0.0f), 1);//壁奥
		SetBird(D3DXVECTOR3(2200.0f,1500.0f, -590.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXVECTOR3(-9.0f, 0.0f, 0.0f), 1);//壁奥
	}
	else if (g_nBirdCounter % 240 == 0)
	{
		SetBird(D3DXVECTOR3(620.0f, 1500.0f, -590.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXVECTOR3(-7.0f, 0.0f, 0.0f), 1); //車1
		SetBird(D3DXVECTOR3(250.0f, 1500.0f, -590.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXVECTOR3(-7.0f, 0.0f, 0.0f), 1); //車1
		SetBird(D3DXVECTOR3(1500.0f,1500.0f, -590.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXVECTOR3(-7.0f, 0.0f, 0.0f), 1);//壁奥
		SetBird(D3DXVECTOR3(1040.0f,1500.0f, -590.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXVECTOR3(-7.0f, 0.0f, 0.0f), 1);//壁奥
	}
...
void SetBird(D3DXVECTOR3 pos, D3DXVECTOR3 rot, D3DXVECTOR3 move, int nType)	//type追加
{
	for (int nCntBird = 0; nCntBird < MAX_BIRD; nCntBird++)
	{
		...
		{//ブロックが使用されてない場合
			g_Bird[nCntBird].pos = pos;
			g_Bird[nCntBird].rot = rot;
			g_Bird[nCntBird].move = move;
			g_Bird[nCntBird].bUse = true;	//使用している状態にする
			g_Bird[nCntBird].nType = nType;
